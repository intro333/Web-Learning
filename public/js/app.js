...
$(document).on('mouseover', '.mob-nav-elem', function () {
    $('.mob-rectangle').css('background', '#333');
});
$(document).on('mouseout', '.mob-nav-elem', function () {
    $('.mob-rectangle').css('background', '');
});
// $(document).on('mouseover', '.mob-menu-right', function () {
//     $('.mob-menu-right').css('color', '#333');
// });
// $(document).on('mouseout', '.mob-menu-right', function () {
//     $('.mob-menu-right').css('color', '');
// });
